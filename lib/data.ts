...
export const testimonials = [
  {
    ...
    quote: "Nexora’s adhesives and waterproofing solutions helped us keep the schedule on a complex residential tower project.",
  },
  {
    name: "Global Sourcing Team",
    role: "Distributor, UAE",
    quote: "The export-ready packaging and product support made Nexora an easy partner for our regional supply chain.",
  },
  {
    name: "Site Engineer",
    role: "Commercial Fit-Out",
    quote: "Their grout and putty products delivered a smooth finish with minimal rework.",
  },
];
